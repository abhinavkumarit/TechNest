import img1 from '../ClothingImg/imgMen.jpg';
import img2 from '../ClothingImg/imgWomen.jpg';
import img3 from '../ClothingImg/imgKids.jpg';
    ...
    return ( 
        <>
            ...
            <div className="container my-4">
                <h1 className='text-center text-primary fw-bold '>Greet Deals On Fashion Wears</h1>
            </div>
                            ...
                            <div className="col-md-4 mb-4" key={x.id}>
                                <div className="card h-100">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title fw-bold">{x.product}</h5>
