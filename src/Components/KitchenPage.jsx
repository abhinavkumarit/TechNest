import img1 from '../KitchensImg/KitchenImg1.jpg';
import img2 from '../KitchensImg/KitchenImg2.jpg';
import img3 from '../KitchensImg/KitchenImg3.jpg';
    ...
    return ( 
        <>
            ...
            <div className="container my-4">
                <h1 className='text-center text-primary fw-bold'> Kitchen Must Haves</h1>
            </div>
